...
exports.run = function (gulp, config) {
  ...
  var hub = new HubRegistry([conf.path.tasks('*.js'), conf.path.tasks('../lib_tasks/others.js')]);

  // Tell gulp to use the tasks just loaded
  gulp.registry(hub);

  var buildTasks = ['clean', 'pug', 'styles', 'scripts', 'partials', 'inject', 'other', 'fonts', 'json', 'others', 'build:finish', 'manifest', 'build:cleanup'];
